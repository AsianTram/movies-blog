import {
  ...
  FOLLOW_POST_BY_ID_PENDING,
  FOLLOW_POST_BY_ID_SUCCESS,
  FOLLOW_POST_BY_ID_FAILED,
  UNFOLLOW_POST_BY_ID_PENDING,
  UNFOLLOW_POST_BY_ID_SUCCESS,
  UNFOLLOW_POST_BY_ID_FAILED,
  PostType
} from '../../types'
...
export function followPost(id: string) {
  return {
    type: FOLLOW_POST_BY_ID_PENDING,
    payload: id
  }
}
export function followPostSuccess(data: {
  user: string,
  followedpost: {
    postid: string,
    type: PostType
  ...
  return {
    type: FOLLOW_POST_BY_ID_SUCCESS,
    payload: data
  }
}
export function followPostFailed(e: Error) {
  return {
    type: FOLLOW_POST_BY_ID_FAILED,
    payload: e
  }
}

export function unfollowPost(id: string) {
  return {
    type: UNFOLLOW_POST_BY_ID_PENDING,
    payload: id
  }
}
export function unfollowPostSuccess(data: {
  profilefollow: string,
  postUnfollow:string
}) {
  return {
    type: UNFOLLOW_POST_BY_ID_SUCCESS,
    payload: data
  }
}
export function unfollowPostFailed(e: Error) {
  return {
    type: UNFOLLOW_POST_BY_ID_FAILED,
    payload: e
  }
}